...
def loop(source):
    ...
    if guess:
        tghosts = {"deogen": ["deodorant", "dia", "doj", "deal jen", ". gin", ". jen", "kyojin", "dieldrin"], "jinn": ["jen", "gin"],  "goryo": ["gorio", "correo", "goryeo"], "hantu": ["han to", "onto", "en tu", "khon2"], "moroi": ["morrow", "mora", "morris", "maura", "morai"], "myling": ["mylink", "miling", "mailing"], "obake": ["obaka", "obok a", "baki", "obate", "obagi"],
